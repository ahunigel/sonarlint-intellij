...
public class ShowModuleAnalysisResultsCallable implements AnalysisCallback {
  ...
  public ShowModuleAnalysisResultsCallable(Module module, Collection<VirtualFile> affectedFiles, String whatAnalyzed) {
    this.module = module;
    this.analysisResultIssues = SonarLintUtils.get(module, AnalysisResultIssues.class);
    this.issueManager = SonarLintUtils.get(module, IssueManager.class);
  ...
  private void showAnalysisResultsTab() {
    UIUtil.invokeLaterIfNeeded(() -> ServiceManager.getService(IssuesViewTabOpener.class)
      .openAnalysisResults());
  }
}
